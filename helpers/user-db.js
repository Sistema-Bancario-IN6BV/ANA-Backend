...
export const createNewUser = async (userData) => {
  ...
  try {
    ...
    // Asignar rol (usar ELDERLY_ROLE por defecto si no se proporciona)
...
/**
 * Obtener todos los usuarios con rol ELDERLY_ROLE
 * @returns {Promise<Array>} Array de usuarios adultos mayores
 */
...
/**
 * Obtener los caregivers vinculados a un adulto mayor
 * Nota: Esta función requiere una tabla de relación caregiver_elderly
 * @param {string} elderlyId - ID del adulto mayor
 * @returns {Promise<Array>} Array de cuidadores
 */
export const findCaregiversByElderly = async (elderlyId) => {
  try {
    ...
    // Retornar cuidadores vinculados
    // Nota: Se requiere implementar tabla/relación caregiver_elderly en database
    // Por ahora, retornar array vacío como placeholder
    return [];
  } catch (error) {
